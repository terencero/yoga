        ...
        return (
            <div className="about-section">
                ...
                <img src="./images/mainPic.png" alt="Profile Picture" height="150px" id="profile-pic" />
                    ...
                    <br></br>
                    <p>In the midst of chaotic life as a new mom of two children, I discovered Ashtanga Vinyasa yoga and its welcoming community. I felt a sense of coming home with this practice since everywhere I went everybody was speaking the same language that is yoga. After discovering the rest of the limbs of yoga beyond asanas, I delved deeply into yoga philosophy &amp; history and realized that the more I studied the more there was to learn.</p>
                    <br></br>
